  ...
  return (
    <div className="flex min-h-screen flex-col bg-background overflow-x-hidden">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-16 md:py-24 lg:py-32 xl:py-40 bg-gradient-to-br from-accent via-background to-secondary/5 relative overflow-hidden">
            ...
            <div className="grid gap-12 lg:grid-cols-2 items-center">
              <div className="flex flex-col justify-center space-y-8 animate-in fade-in slide-in-from-left duration-1000">
                ...
                <div className="flex flex-col gap-3 min-[400px]:flex-row">
                  ...
                  <Link href="#hope">
                    <Button variant="ghost" size="lg" className="h-14 px-8 rounded-2xl text-muted-foreground hover:text-primary transition-all">
                      Messages d'espoir
                    </Button>
                  </Link>
                </div>
              ...
              <div className="relative group animate-in fade-in zoom-in duration-1000">
                ...
                <div className="relative overflow-hidden rounded-[2.5rem] border-[6px] border-card shadow-2xl bg-card">
                   <Image
                    ...
                    priority
                  />
                  <div className="absolute bottom-6 left-6 right-6 bg-background/90 backdrop-blur p-4 rounded-2xl border border-border shadow-lg">
                    <div className="flex items-center gap-3">
                      <div className="h-10 w-10 rounded-full bg-secondary flex items-center justify-center text-white">
                        <Activity className="h-5 w-5" />
                      </div>
                      <div>
                        <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Suivi en temps réel</p>
                        <p className="text-sm font-bold text-foreground">Plus de 2 500 patients suivis</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <section id="hope" className="w-full py-24 bg-background relative">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center space-y-6 mb-16 animate-in fade-in slide-in-from-bottom duration-700">
              ...
              <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl text-foreground">Messages de courage & d'espoir</h2>
              <div className="h-1.5 w-24 bg-primary rounded-full" />
              <p className="max-w-[800px] text-muted-foreground text-lg font-medium leading-relaxed">
        ...
        <section className="w-full py-24 bg-foreground dark:bg-card text-background dark:text-foreground overflow-hidden relative">
            ...
            <div className="flex flex-col items-center text-center space-y-8">
              ...
              <blockquote className="max-w-[900px]">
                ...
                <footer className="mt-8 flex flex-col items-center gap-2">
                  ...
                  <span className="text-muted-foreground font-medium tracking-[0.2em] uppercase text-sm italic">
                    — Hippocrate
                  </span>
                </footer>
              </blockquote>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="grid grid-cols-2 gap-6 relative">
                ...
                <div className="space-y-6 mt-12">
                  <div className="aspect-square rounded-[2.5rem] bg-card p-3 shadow-xl border border-border group overflow-hidden">
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-4xl mx-auto space-y-16">
              <div className="text-center space-y-6">
                ...
                <h2 className="text-3xl font-extrabold tracking-tight sm:text-5xl text-foreground leading-tight">Accompagnement & <span className="text-primary">Questions</span></h2>
              ...
              <div className="grid gap-8">
                {[
                  ...
                  <div key={i} className="group p-6 md:p-10 rounded-[2.5rem] bg-muted/30 border border-border hover:border-primary/20 hover:bg-card hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500">
                    <h4 className="text-lg md:text-xl font-bold text-foreground flex items-center gap-4 mb-4">
                      <div className="h-10 w-10 md:h-12 md:w-12 shrink-0 rounded-2xl bg-card shadow-md flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors">
                        <item.icon className="h-5 w-5 md:h-6 md:w-6" />
                      </div>
                      <span className="flex-1">{item.q}</span>
                    </h4>
                    <p className="text-muted-foreground leading-relaxed pl-6 md:pl-16 italic text-base md:text-lg border-l-2 border-primary/20">
                      "{item.a}"
                    </p>
                  </div>
                ))}
        ...
        <section id="contact" className="w-full py-24 bg-muted/30">
          <div className="container px-4 md:px-6">
            <div className="max-w-5xl mx-auto bg-card rounded-[3rem] shadow-2xl shadow-zinc-900/10 overflow-hidden border border-border">
                ...
                <div className="p-8 md:p-12 space-y-8">
                  <div className="grid gap-6">
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-muted-foreground tracking-wide">Nom complet</label>
                      <input className="w-full h-14 px-5 rounded-2xl border border-border bg-background focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium" placeholder="Votre nom" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-muted-foreground tracking-wide">Email</label>
                      <input className="w-full h-14 px-5 rounded-2xl border border-border bg-background focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium" placeholder="votre@email.com" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-sm font-bold text-muted-foreground tracking-wide">Message</label>
                      <textarea className="w-full h-32 p-5 rounded-2xl border border-border bg-background focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none transition-all font-medium resize-none" placeholder="Comment pouvons-nous vous aider ?"></textarea>
                    </div>
                  </div>
        ...
        <section className="w-full py-24 bg-background">
          <div className="container px-4 md:px-6 text-center">
            <div className="max-w-4xl mx-auto space-y-10">
              ...
              <h2 className="text-4xl font-extrabold tracking-tighter sm:text-6xl text-foreground leading-[1.1]">
              ...
              <div className="flex flex-col sm:flex-row gap-5 justify-center pt-4">
                <Link href="/register">
                  <Button size="lg" className="h-16 px-10 rounded-[1.5rem] bg-foreground text-background hover:bg-foreground/90 text-xl font-bold shadow-2xl shadow-foreground/5 transition-all hover:scale-105">
                    Créer mon compte
                  </Button>
                </Link>
                <Link href="/login">
                  <Button variant="outline" size="lg" className="h-16 px-10 rounded-[1.5rem] border-border text-xl font-bold hover:bg-accent transition-all hover:border-secondary hover:text-secondary">
                    Me connecter
                  </Button>
                </Link>
              </div>
      ...
      <footer className="w-full py-16 border-t border-border bg-background">
        <div className="container px-4 md:px-6 flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black tracking-tighter text-foreground">MediCare</span>
          </div>
